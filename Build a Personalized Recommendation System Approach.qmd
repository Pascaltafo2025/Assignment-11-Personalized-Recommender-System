...
ratings_matrix <- TV_Show_ratings_long %>%
  pivot_wider(names_from = show, values_from = rating)
...
The recommender system outputs a ranked list of the top-N TV shows for each user that they have not yet rated, based on predicted ratings derived from similar users.
